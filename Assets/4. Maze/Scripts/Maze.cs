...
public class Maze : MonoBehaviour
{
    ...
    /// some uninitialized edge. 
    /// If the cell edges already are fully initialized, remove the current cell 
    /// from the activeCells list and try again.
    /// If the cell still has some uninitialized edge, checks if there is a cell in 
